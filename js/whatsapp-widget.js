(function () {
  ...
  link.innerHTML =
    ...
    '</span>' +
    '<span class="relative flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-[#8E84F1] shadow-[0_0_0_4px_rgba(142,132,241,0.2)] transition-shadow duration-300 group-hover:shadow-[0_0_0_6px_rgba(142,132,241,0.35)]" aria-hidden="true">' +
